    ...
    >
      ...
      >
        {cards.map((card) => (
          <div
            key={card.icon}
            className="context-card bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8 text-center hover:border-eu-gold/30 transition-colors duration-300"
          >
